...
* modify / add or remove the data within. This library is meant
* to work with MySQL versions 4.1.x and up.
*
...
*/
class MySql41Handler extends DatabaseHandler
{
   // ! Constructor Method
    ...
    * @return Void
    */
	function MySql41Handler($server_host, $server_port)
	{
    ...
    */
	function doConnect($username, $password, $database, $persist = true)
	{
        ...
        {
            die("<strong>ERROR:</strong> You do not have the proper PHP extension installed " .
   ...
   /**
    * Executes a user-define query for the database.
    *
    ...
    */
	function query($sql, $file = '', $line = '', $ignore_errors = false)
	{
        ...
        return new MySql41Iterator($result);
	}
    ...
    */
    function getVersion()
    {
       $bits = explode('.', mysqli_get_server_info($this->getConnectionId()));
    ...
    */
	...
	{
        $error = mysqli_error($this->getConnectionId());
    ...
    */
	...
	{
		return mysqli_close($this->getConnectionId());
	}
...
class MySql41Iterator
{
    ...
    * @return Void
    */
	function MySql41Iterator($resource_id)
	{
    ...
    */
	function getNumRows()
	{
        $this->_total_rows = mysqli_num_rows($this->getResourceId());
    ...
    */
    ...
    {
        mysqli_free_result($this->getResourceId());
    ...
    */
	function getRow($result_type = 'assoc')
	{
        ...
        {
		  	case 'row':
			  return mysqli_fetch_row($this->getResourceId());
			  break;

			case 'assoc':
			  return mysqli_fetch_assoc($this->getResourceId());
			  break;

			case 'both':
			  return mysqli_fetch_array($this->getResourceId());
			  break;
		}
	}
}
